          ...
          <div className="hidden md:flex items-center space-x-8">
            {NAV_LINKS.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="text-black hover:text-[hsl(var(--color-secondary))] px-4 py-2 rounded-md transition-all duration-300 font-medium relative group"
              >
                {link.label}
                ...
                {NAV_LINKS.map((link, index) => (
                  ...
                  >
                    <Link
                      ...
                      className="block py-3 px-4 rounded-md text-black hover:text-[hsl(var(--color-secondary))] hover:underline hover:bg-[hsl(var(--color-secondary))]/10 transition-all duration-300 font-medium"
                    >
                      {link.label}
                    </Link>
                  </motion.div>
