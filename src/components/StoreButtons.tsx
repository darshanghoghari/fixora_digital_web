...
export const AppleStoreButton = ({ className = "" }: { className?: string }) => {
  return (
    <a
      href="#"
    ...
    >
      ...
      <div className="flex flex-col items-start justify-center">
        ...
        <span className="text-xs sm:text-sm font-semibold leading-tight mt-[1px]">
          App Store
        </span>
      </div>
    </a>
...
export const GooglePlayButton = ({ className = "" }: { className?: string }) => {
  return (
    ...
    >
      ...
      <div className="flex flex-col items-start justify-center">
        <span className="text-[9px] sm:text-[10px] leading-tight font-medium">GET IT ON</span>
        <span className="text-xs sm:text-sm font-semibold leading-tight mt-[1px]">
          Google Play
        </span>
      </div>
